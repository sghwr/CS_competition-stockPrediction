...
class MarketStateExtractor:
    def __init__(self, index_csv='/app/data/index_data.csv'):
...
class IndustryPriorComputer:
    def __init__(self, industry_csv='/app/data/stock_industry.csv',
                 stock_data_csv='/app/data/stock_data.csv',
                 lookback=5):
        self.industry_path = Path(industry_csv)
        self.stock_data_path = Path(stock_data_csv)
